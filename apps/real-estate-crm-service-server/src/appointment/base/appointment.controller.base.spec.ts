  ...
  test("POST /appointments", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateAndTime: CREATE_RESULT.dateAndTime.toISOString(),
      ...
      .expect([
        {
          ...
          dateAndTime: FIND_MANY_RESULT[0].dateAndTime.toISOString(),
  ...
  test("GET /appointments/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateAndTime: FIND_ONE_RESULT.dateAndTime.toISOString(),
